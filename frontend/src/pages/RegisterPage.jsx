...
export default function RegisterPage() {
  ...
  if (done) {
    return (
      ...
      >
        <div className="text-center max-w-md bg-zinc-950/40 backdrop-blur-md border border-zinc-900/80 rounded p-8 shadow-xl">
          <div className="text-4xl mb-4">📧</div>
          <h2 className="text-white text-xl font-serif italic mb-2">Check your email!</h2>
          <p className="text-zinc-400 text-sm mb-6 leading-relaxed">We sent a confirmation link to your email. Click it to activate your account.</p>
          <Link to="/login" className="text-amber-500 hover:text-amber-450 font-mono text-xs uppercase tracking-widest font-bold">Back to login</Link>
        </div>
      </div>
    );
  }
    ...
    >
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-zinc-400 text-[10px] uppercase tracking-[0.25em] font-semibold mt-4 font-mono">Create your account</h1>
        </div>
        ...
        <div className="bg-zinc-950/40 backdrop-blur-md border border-zinc-900/80 rounded p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              <label className="block text-[10px] uppercase tracking-widest text-zinc-400 font-mono mb-1.5">Full Name</label>
              <input
          ...
          <p className="text-center text-zinc-400 text-xs mt-6 font-sans">
            ...
            <Link to="/login" className="text-amber-500 hover:text-amber-400 font-semibold font-mono uppercase tracking-wider ml-1">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
